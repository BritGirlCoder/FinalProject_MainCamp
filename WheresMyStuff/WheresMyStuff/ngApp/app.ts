namespace WMS {
    ...
    angular.module("WMS", ["ngRoute", "ngResource", "ui.bootstrap", "uiGmapgoogle-maps", "angular-filepicker"]).config(($routeProvider: ng.route.IRouteProvider,
    ...
    angular.module('WMS').factory('authInterceptor', (
        $q: ng.IQService,
